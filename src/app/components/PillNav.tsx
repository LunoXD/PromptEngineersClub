...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="relative w-full md:w-auto">
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute top-[54px] left-0 right-0 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.4)] z-[998] origin-top"
        style={{ ...cssVars, background: 'var(--base, #111)' }}
      >
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px]">
          {items.map(item => {
            ...
            const linkClasses =
              'block py-3 px-4 text-[14px] font-semibold uppercase tracking-[0.2px] rounded-[50px] transition-all duration-200';
